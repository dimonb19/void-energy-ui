...
- **Button typography is sentence case by default** (Phase 0b modernization, 2025-2026 alignment with MD3/shadcn/Linear). Buttons use `font-weight: medium` (500), `letter-spacing: 0.02em`, `text-transform: none`. CTA (`.btn-cta`) also follows sentence case — its importance is asserted through extrabold weight and the animated comet border, not uppercase. For consumers who need the assertive uppercase treatment, use `.btn-loud` (uppercase + 0.05em tracking + semibold).
